...
export interface LootboxTicketInterface extends utils.Interface {
  functions: {
...
export interface LootboxTicket extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LootboxTicketInterface;
  ...
  populateTransaction: {
    ...
    lastTicketId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
