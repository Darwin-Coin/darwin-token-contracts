...
export interface DarwinVester5Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "vestUser", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "vestUser", data: BytesLike): Result;
...
export interface DarwinVester5 extends BaseContract {
  ...
  interface: DarwinVester5Interface;
  ...
  functions: {
    ...
    vestUser(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    vestUser(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    vestUser(overrides?: CallOverrides): Promise<PopulatedTransaction>;
